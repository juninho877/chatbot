            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <h1 class="text-2xl font-bold text-blue-600"><?php echo getSiteName(); ?></h1>
                    </div>
                </div>
                <!-- Menu para desktop -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white p-6 md:p-8 rounded-xl shadow-lg hover:shadow-xl transition">
                    ...
                    <h3 class="text-xl font-semibold mb-4 text-gray-900">Gestão de Clientes</h3>
                ...
                <div class="bg-white p-6 md:p-8 rounded-xl shadow-lg hover:shadow-xl transition">
                    ...
                    <h3 class="text-xl font-semibold mb-4 text-gray-900">WhatsApp Automático</h3>
                    <p class="text-gray-600">
                ...
                <div class="bg-white p-6 md:p-8 rounded-xl shadow-lg hover:shadow-xl transition">
                    ...
                    <h3 class="text-xl font-semibold mb-4 text-gray-900">Relatórios Detalhados</h3>
                    <p class="text-gray-600">
                ...
                <div class="bg-white p-6 md:p-8 rounded-xl shadow-lg hover:shadow-xl transition">
                    ...
                    <h3 class="text-xl font-semibold mb-4 text-gray-900">Pagamento via PIX</h3>
                    <p class="text-gray-600">
                ...
                <div class="bg-white p-6 md:p-8 rounded-xl shadow-lg hover:shadow-xl transition">
                    ...
                    <h3 class="text-xl font-semibold mb-4 text-gray-900">Templates de Mensagem</h3>
                    <p class="text-gray-600">
                ...
                <div class="bg-white p-6 md:p-8 rounded-xl shadow-lg hover:shadow-xl transition">
                    ...
                    <h3 class="text-xl font-semibold mb-4 text-gray-900">Segurança Total</h3>
                    <p class="text-gray-600">
